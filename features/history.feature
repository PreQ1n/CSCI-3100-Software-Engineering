...
Background:
  ...
  And the following history equipment_records exist:
    ...
    | 1       | 1            | 2026-03-01  | 2026-03-03           | false      | false         |
    | 1       | 2            | 2026-03-02  | 2026-03-04           | false      | true          |
...
Scenario: Switch to equipment bookings
  ...
  And the table should have columns "Name", "Borrow Date", "Expected Return Date", "Is Absence", "Is Return Late"
