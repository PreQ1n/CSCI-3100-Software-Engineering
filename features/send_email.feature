...
Scenario: user books a venue and receives booking confirmation email
  When a venue record is created for "user@example.com" at "MMW LT1" on "2026-03-08" at "11:00"
